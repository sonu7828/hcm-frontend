...
export const sidebarConfig = {
  ...
  hr: [
    ...
    { label: 'Offboarding & Resignations', icon: UserMinus, path: '/hr/offboarding', permission: 'always' },
    { label: 'Payroll Operations', icon: CreditCard, path: '/hr/payroll' },
    { label: 'Approvals', icon: CheckSquare, path: '/hr/approvals', permission: 'always' },
  ...
  employee: [
    ...
    { label: 'Compliance', icon: Scale, path: '/employee/compliance', permission: 'always' },
    { label: 'Resignation', icon: UserMinus, path: '/employee/resignation', permission: 'always' },
  ],
  ...
  manager: [
    ...
    { label: 'Team Resignations', icon: UserMinus, path: '/manager/resignations', permission: 'always' },
    { label: 'Reimbursements', icon: Receipt, path: '/manager/reimbursements', permission: 'always' },
  ...
  admin: [
    ...
    { label: 'Shift Management', icon: Clock, path: '/admin/shifts', permission: 'always' },
    { label: 'Overtime Rules', icon: Clock, path: '/admin/overtime', permission: 'always' },
    ...
    { label: 'Resignations', icon: UserMinus, path: '/admin/resignations', permission: 'always' },
    { label: 'Reimbursements', icon: Receipt, path: '/admin/reimbursements', permission: 'always' },
    { label: 'Audit Logs', icon: FileSearch, path: '/admin/audit' },
    { label: 'Reports', icon: BarChart2, path: '/admin/reports' },
    { label: 'Settings', icon: Settings, path: '/admin/settings' },
    { label: 'Approval Workflows', icon: GitMerge, path: '/admin/workflows', permission: 'always' },
  ],
};